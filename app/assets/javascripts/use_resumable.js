...
r.on('fileAdded', function(file){
  ...
  $('.resumable-list').append('<div title="remove" class="resumable-file-'+file.uniqueIdentifier+' corpi_item_small resumable-remove span11" data-iden="'+file.uniqueIdentifier+'"><span class="remove-warning"></span><span class="resumable-file-name label label-info"></span> <span class="resumable-file-progress"></div>');
